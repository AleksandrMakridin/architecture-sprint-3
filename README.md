...
5. Уведомления и отчетность:
    - Отправка уведомлений пользователям о состоянии устройств и выполнении сценариев, плюс итоговая отчетность - например в клонце месяца отчет об электрозатратах и т.п..
